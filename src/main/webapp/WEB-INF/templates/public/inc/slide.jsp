            ...
            <div class="col-sm-12 header-top-right">
                <div class="homeslider">
                    <ul id="contenhomeslider">
                        <li><img alt="Funky roots" src="/resources/templates/public/images/slide/covid.jpg" title="Funky roots"/></li>
                        <li><img alt="Funky roots" src="/resources/templates/public/images/slide/covid-19.png" title="Funky roots"/></li>
